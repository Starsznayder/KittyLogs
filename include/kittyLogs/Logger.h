#ifndef KITTY_LOGS_LOG_DETAILS_LOGGER_H
#define KITTY_LOGS_LOG_DETAILS_LOGGER_H
...
struct Logger
{
    ...
    static void init(sink, const std::string& addr = "235.0.0.50", const uint16_t& port = 50110)
    {
